...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="bg-primary text-white mb-0" id="about">
      <div class="container">
        <h2 class="text-center text-uppercase text-white">Professional Summary</h2>
    ...
    <footer class="footer text-center">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-5 mb-lg-0">
            <h4 class="text-uppercase mb-4">Social Media & Resume</h4>
            <ul class="list-inline mb-0">
              <li class="list-inline-item">
                <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://github.com/mbentley999" target="_blank">
